...
INSERT INTO `course_offered` (`id`, `name`, `details`, `created_at`, `updated_at`) VALUES
(1, 'Bangla', 'Bangla', NULL, NULL),
...
(152, '2021_12_18_093928_create_course_offered_table', 9),
...
--
-- Constraints for table `courese_teacher_sup`
--
ALTER TABLE `courese_teacher_sup`
  ADD CONSTRAINT `courese_teacher_sup_course_offer_id_foreign` FOREIGN KEY (`course_offer_id`) REFERENCES `course_offered` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `courese_teacher_sup_teacher_id_foreign` FOREIGN KEY (`teacher_id`) REFERENCES `teachers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
